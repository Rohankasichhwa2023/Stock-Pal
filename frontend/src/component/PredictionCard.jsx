...
const PredictionCard = () => {
    ...
    const { next_day_prediction, classification_metrics } = data;
    const imageUrl = `http://127.0.0.1:8000/outputs/${symbol}/${symbol}_prediction.png`;
        ...
        <div className="prediction-card">
            ...
            <div className="prediction-card__next-day">
                ...
                <div className="prediction-card__details">
                    <div><strong>Predicted Price:</strong> {next_day_prediction.pred_price.toFixed(2)}</div>
                    <div><strong>Movement:</strong>
            ...
            <div className="prediction-card__metrics">
                ...
                <div><strong>Accuracy:</strong> {(classification_metrics.accuracy * 100).toFixed(2)}%</div>
                <div><strong>Weighted F1:</strong> {(classification_metrics.weighted_f1 * 100).toFixed(2)}%</div>
            </div>
            ...
            <div className="prediction-card__recent">
                <h3>Sample Predictions (Last 10 Days)</h3>
                            ...
                            {data.predictions
                                ...
                                .map((item, idx) => (
                                    <tr key={idx}>
                                        ...
                                        <td>{item.pred_close.toFixed(2)}</td>
                                        <td>
